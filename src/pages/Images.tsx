    ...
    return (
      <div className="flex items-center justify-center h-screen bg-[#fafafa]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm font-medium text-slate-500">正在加载图片...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex h-screen bg-[#fafafa] text-slate-900">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <TopBar pageTitle="照片" showRefreshButton onRefresh={fetchImageFiles} />
          ...
          <div className="max-w-400">
            ...
            {groupedByDate.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-32 bg-white border border-dashed border-slate-200 rounded-2xl">
                ...
                <p className="text-slate-500 text-sm mt-1">您上传的图片会出现在这里</p>
              </div>
            ) : (
                      ...
                      {group.map((file, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="relative aspect-square bg-slate-50 overflow-hidden cursor-pointer" onClick={() => setPreviewFile(file)}>
                              <img
