...
export default function FilePreviewModal({ file, onClose }: FilePreviewModalProps) {
      ...
      return (
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <p className="text-lg text-[#64748b] mb-4">预览加载失败</p>
            <button
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#1a1d2e] rounded-2xl shadow-2xl flex flex-col max-w-7xl w-full h-[90vh] overflow-hidden">
        {/* Header */}
        <div className="h-16 bg-[#1a1d2e]/95 backdrop-blur-sm flex items-center justify-between px-6 border-b border-white/10">
